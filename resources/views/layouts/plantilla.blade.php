...
<body>
  ...
  "
                    ...
                    <div class="flex items-center relative">
                        <div class="dropdown relative">
                            <ul class="navbar-nav flex flex-col pl-0 list-style-none mr-auto">
                                ...
                                <li>
                                    <div class="nav-link text-gray-500 hover:text-gray-700 focus:text-gray-700 p-0">
                                        <a href="/editarPerfil" id="dropdownMenuButton2" role="button"
                                            data-bs-toggle="dropdown" aria-expanded="false" onclick="event.preventDefault();
                                            document.getElementById('edit-form').submit();">
                                            <img src="img/avatar.png" class="rounded-full"
                                                style="height: 25px; width: 25px" alt=""
                                                loading="lazy" />{{ Auth::user()->name }}
                                        </a>

                                        <form id="edit-form" action="/editarPerfil" method="GET"
                                            class="d-none">
                                            @csrf
                                        </form>
                                    </div>
    ...
    <main style="padding: 5%">
        <div class="col-auto bd-danger p-5 text-center">
            <div class="container">
                @yield('contenido')
            </div>
        </div>
